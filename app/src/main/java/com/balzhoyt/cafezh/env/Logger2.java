...
package com.balzhoyt.cafezh.env;
...
public final class Logger2 {
  ...
  static {
    ...
    IGNORED_CLASS_NAMES.add(Logger2.class.getCanonicalName());
  }
   ...
   */
  public Logger2(final Class<?> clazz) {
   ...
   */
  public Logger2(final String messagePrefix) {
   ...
   *     being used
   */
  public Logger2(final String tag, final String messagePrefix) {
    this.tag = tag;
  ...
  /** Creates a Logger using the caller's class name as the message prefix. */
  public Logger2(final int minLogLevel) {
    this(DEFAULT_TAG, null);
  ...
  private static String getCallerSimpleName() {
    ...
    return Logger2.class.getSimpleName();
  }
