...
import com.balzhoyt.cafezh.env.ImageUtils;
import com.balzhoyt.cafezh.env.Logger;
import com.balzhoyt.cafezh.tflite.Classifier.Device;
import com.balzhoyt.cafezh.tflite.Classifier.Model;
import com.balzhoyt.cafezh.tflite.Classifier;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected void showResultsInBottomSheet(List<Classifier.Recognition> results) {
    if (results != null && results.size() >=2 ) {
      ...
      Classifier.Recognition recognition2 = results.get(1);
